...
Description: THIS PLUGIN HAS BEEN TAILORED FOR HANDGLOVES DO NOT UPGRADE.
Version: 1.1
Author: David Wood 
...
/*  
			...
			This plugin has been modified to work with Handgloves						
...
function get_twitter_msg() {
	...
	$tweeter = get_option($_opt_twitter_id);
		
	echo '
		<a href="http://twitter.com/'.$tweeter.'" class="latest-tweet">
